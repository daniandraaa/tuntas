...
<body style="background-color: #333353;">
    ...
    <div class="pembungkus px-2">
        ...
        @foreach ($mapels->where('status', 'proses') as $mapel)
            <div class="pembungkus px-2" style="margin-top: 60px ">
                <div class="container mt-2 px-5 py-2"
                    ...
                    <p class="text-white" style="margin-bottom: -100px; font-size: calc(0.75rem + ((1vw - 7.68px) * 0.6944))">Sedang Menunggu Verifikasi</p>
                </div>
            </div>
        @endforeach
