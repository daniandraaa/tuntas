...
<body style="background-color: #333353;">
    ...
    <div class="pembungkus px-2">
        ...
        <a href="/belumtuntas" class="text-decoration-none">
            <div class="container" id="belumtuntas"
                style="box-shadow: 0px 21px 14px 0px rgba(0,0,0,0.25); background-color: #008189; border-radius: 50px; margin-top: 60px; align-items: center; justify-content: center; text-align: center ">
                    <h1 style="color: white; text-shadow: 0 0 10px white; height: calc(7rem + ((1vw - 7.68px) * 0.6944)); align-items: center; justify-content: center; display: flex">Belum Tuntas</h1>
            </div>
        </a>
        <a href="/sudahtuntas" class="text-decoration-none">
            <div class="container" id="sudahtuntas"
                style="-webkit-box-shadow: 0px 21px 14px 0px rgba(0,0,0,0.25); background-color: #008189; border-radius: 50px; margin-top: 60px; align-items: center; justify-content: center; text-align: center ">
                    <h1 style="color: white; text-shadow: 0 0 10px white; height: calc(7rem + ((1vw - 7.68px) * 0.6944)); align-items: center; justify-content: center; display: flex">Sudah Tuntas</h1>
            </div>
        </a>
        <a href="/prosespenuntasan" class="text-decoration-none">
            <div class="container" id="prosespenuntasan"
                style="-webkit-box-shadow: 0px 21px 14px 0px rgba(0,0,0,0.25); background-color: #008189; border-radius: 50px; margin-top: 60px; align-items: center; justify-content: center; text-align: center ">
                    <h1 style="color: white; text-shadow: 0 0 10px white; height: calc(7rem + ((1vw - 7.68px) * 0.6944)); align-items: center; justify-content: center; display: flex">Proses Penuntasan</h1>
            </div>
        </a>
